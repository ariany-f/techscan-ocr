...
function RelatorioDashboard() {
  ...
  function configurarGraficos(dianteira, traseira, container) {
    ...
    if(traseira[0]) {
      let totPassagensTraseira = ((parseInt(traseira[0]['Acertos']) + parseInt(traseira[0]['Erros']))*0.6)
    ...
    if(container[0]) {
      let totPassagensContainer = ((parseInt(container[0]['Acertos']) + parseInt(container[0]['Erros']))*0.5)
